...
connect_debug_port u_ila_0_0/probe0 [get_nets [list {fp_ram_addrb[0]} {fp_ram_addrb[1]} {fp_ram_addrb[2]} {fp_ram_addrb[3]} {fp_ram_addrb[4]} {fp_ram_addrb[5]} {fp_ram_addrb[6]} {fp_ram_addrb[7]} {fp_ram_addrb[8]} {fp_ram_addrb[9]} {fp_ram_addrb[10]} {fp_ram_addrb[11]} {fp_ram_addrb[12]} {fp_ram_addrb[13]} {fp_ram_addrb[14]} {fp_ram_addrb[15]} {fp_ram_addrb[16]}]]
create_debug_port u_ila_0_0 probe
set_property port_width 13 [get_debug_ports u_ila_0_0/probe1]
connect_debug_port u_ila_0_0/probe1 [get_nets [list {samp_ram0_addra[0]} {samp_ram0_addra[1]} {samp_ram0_addra[2]} {samp_ram0_addra[3]} {samp_ram0_addra[4]} {samp_ram0_addra[5]} {samp_ram0_addra[6]} {samp_ram0_addra[7]} {samp_ram0_addra[8]} {samp_ram0_addra[9]} {samp_ram0_addra[10]} {samp_ram0_addra[11]} {samp_ram0_addra[12]}]]
create_debug_port u_ila_0_0 probe
set_property port_width 13 [get_debug_ports u_ila_0_0/probe2]
connect_debug_port u_ila_0_0/probe2 [get_nets [list {samp_ram1_addra[0]} {samp_ram1_addra[1]} {samp_ram1_addra[2]} {samp_ram1_addra[3]} {samp_ram1_addra[4]} {samp_ram1_addra[5]} {samp_ram1_addra[6]} {samp_ram1_addra[7]} {samp_ram1_addra[8]} {samp_ram1_addra[9]} {samp_ram1_addra[10]} {samp_ram1_addra[11]} {samp_ram1_addra[12]}]]
create_debug_port u_ila_0_0 probe
set_property port_width 1 [get_debug_ports u_ila_0_0/probe3]
connect_debug_port u_ila_0_0/probe3 [get_nets [list control/adc_finished]]
create_debug_port u_ila_0_0 probe
set_property port_width 1 [get_debug_ports u_ila_0_0/probe4]
connect_debug_port u_ila_0_0/probe4 [get_nets [list control/run_adc]]
create_debug_port u_ila_0_0 probe
set_property port_width 1 [get_debug_ports u_ila_0_0/probe5]
connect_debug_port u_ila_0_0/probe5 [get_nets [list control/run_fwd_fft]]
create_debug_port u_ila_0_0 probe
set_property port_width 1 [get_debug_ports u_ila_0_0/probe6]
connect_debug_port u_ila_0_0/probe6 [get_nets [list samp_ram0_wea]]
create_debug_port u_ila_0_0 probe
set_property port_width 1 [get_debug_ports u_ila_0_0/probe7]
connect_debug_port u_ila_0_0/probe7 [get_nets [list samp_ram1_wea]]
create_debug_port u_ila_0_0 probe
set_property port_width 1 [get_debug_ports u_ila_0_0/probe8]
connect_debug_port u_ila_0_0/probe8 [get_nets [list control/threshold_flag]]
